...
export default function EmailTemplate({
  ...
  if (type === "budget-alert") {
    ...
    return (
      <Html>
        <Head />
        <Preview>{isExceeded ? "CRITICAL: Budget Exceeded" : "Budget Alert"}</Preview>
        <Body style={styles.body}>
          <Container style={styles.container}>
            <Heading style={{
              ...styles.title,
              color: isExceeded ? "#e11d48" : "#1f2937"
            }}>
            ...
            <Text style={styles.text}>
              {isExceeded
                ? `Critical: You have exceeded your monthly budget by ${data?.percentageUsed.toFixed(1)}%.`
            ...
            <Section style={styles.statsContainer}>
              ...
              <div style={styles.stat}>
                ...
                <Text style={{
                  ...styles.heading,
                  color: isExceeded ? "#e11d48" : "#1f2937"
                }}>₹{Number(data?.totalExpenses).toFixed(2)}</Text>
              </div>
              <div style={styles.stat}>
                <Text style={styles.text}>
                  {isExceeded ? "Amount Over" : "Remaining"}
                </Text>
                <Text style={{
                  ...styles.heading,
                  color: isExceeded ? "#e11d48" : "#059669"
                }}>
                  ₹{Math.abs(data?.budgetAmount - data?.totalExpenses).toFixed(2)}
                </Text>
              </div>
            </Section>
            ...
            <Text style={styles.footer}>
              {isExceeded
                ? "We recommend reviewing your recent transactions and adjusting your spending to stay on track."
                : "Keep up the good work! Tracking your spending helps you reach your financial goals."
              }
            </Text>
          </Container>
        </Body>
